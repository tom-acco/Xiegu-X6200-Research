...
- This writeup is different from the others in this repo: it's not a specific X6200 finding,
  it's the **method** behind them. Every other result in this repo — the
  [Bandplan Display Patch](../Bandplan%20Display%20Patch/README.md) (merged as
  [#3](https://github.com/tom-acco/Xiegu-X6200-Research/pull/3)) and the
  [Bandplan Subdivision Patch](../Bandplan%20Subdivision%20Patch/README.md) follow-up
  ([#4](https://github.com/tom-acco/Xiegu-X6200-Research/pull/4)) — was produced end-to-end
...
- Writing a one-off Python script to emulate a function in isolation (rather than reasoning
  ...
  *and cheap to throw away* when the hypothesis was wrong — which happened repeatedly in this
  ...
  [Bandplan Display Patch README](../Bandplan%20Display%20Patch/README.md#the-channel-mixup-bug)
...
The [Bandplan Display Patch](../Bandplan%20Display%20Patch/README.md) is the clean end-to-end
...
[Bandplan Subdivision Patch](../Bandplan%20Subdivision%20Patch/README.md) follow-up used the
